                ...
                <div>
                    ...
                    <div className='poppins-medium px-5 pb-20'>
                        <header className="text-center mt-40">
                            <h2 className="text-xl font-bold text-gray-900 sm:text-3xl pb-12">Men & Women Collection</h2>
                        </header>
