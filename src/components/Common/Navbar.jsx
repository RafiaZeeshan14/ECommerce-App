...
const Navbar = ({ backgroundColor }) => {
    ...
    const wishlistItemsCount = state.wishlistItems.length;
    return (
        <div>
            <section
            ...
            >
                ...
                <div class="lg:absolute lg:right-10 flex items-center ml-auto space-x-8">
                      {/* ********** Wishlist -Img************ */}
                    <Link to={'/wishlist'} class="relative">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22px"
                         ...
                         {/* ********** Wishlist -Badge************ */}
                        <span class="absolute left-auto -ml-1 top-0 rounded-full bg-black px-1 py-0 text-xs text-white">{wishlistItemsCount}</span>
                    </Link>
                    {/* ********** Basket -Img************ */}
