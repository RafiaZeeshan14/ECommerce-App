...
const Navbar = () => {
    ...
    return (
        <>
            <header class='border-b font-sans min-h-[60px] px-10 py-3 relative text-white poppins-medium'>
                <div class='flex flex-wrap items-center max-lg:gap-y-4 max-sm:gap-x-4'>
                    ...
                    <div class='flex items-center ml-auto lg:order-1'>
                        {/* ********** Heart-Svg************ */}
                        <div
                            class="bg-gray-100 border border-transparent mr-6 focus-within:border-blue-500 flex px-6 rounded-full h-9 lg:w-[60%] mt-1 mx-auto ">
                    ...
                    {/* ********** Nav-Links ************ */}
                    <ul id="collapseMenu"
                        class='text-gray-600  lg:!flex max-lg:hidden max-lg:w-full lg:space-x-10 max-lg:space-y-3 lg:absolute lg:left-[38%] lg:-translate-x-1/2'>
