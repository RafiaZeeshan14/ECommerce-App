...
const Contact = () => {
    ...
    return (
        <div className='poppins-medium'> 
            ...
            <div class="max-w-6xl mx-auto bg-white my-8  mt-14 text-[#011c2b]">
                ...
                <div class="grid lg:grid-cols-3 items-center gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-8">
                    <div class="bg-[#c0c4c7] rounded-lg p-6 max-lg:text-center">
                        <h2 class="text-xl font-bold text-gray-700">Contact Information</h2>
                        <p class="text-sm text-gray-500 mt-3">Have some big idea or brand to develop and need help?</p>
                        <ul class="mt-16 space-y-10">
                            <li class="flex items-center max-lg:justify-center">
                                ...
                                <Link  class="text-gray-600 text-sm ml-3">
                                    <strong>T-ShirtStore.com</strong>
                                </Link>
                            </li>
                            <li class="flex items-center max-lg:justify-center">
                    ...
                    <div class="p-6 rounded-xl lg:col-span-2">
                        <form>
                            <div class="grid sm:grid-cols-2 gap-8">
                                <div class="relative flex items-center">
                                    <input type="text" placeholder="First Name"
                                        class="px-2 py-3 bg-white w-full text-sm border-b-2 focus:border-[#8f9294] outline-none" />
                                ...
                                <div class="relative flex items-center">
                                    <input type="number" placeholder="Phone No."
                                        class="px-2 py-3 bg-white text-black w-full text-sm border-b-2 focus:border-[#8f9294] outline-none" />
                                ...
                                <div class="relative flex items-center sm:col-span-2">
                                    <textarea placeholder="Write Message"
                                        class="px-2 pt-3 bg-white text-black w-full text-sm border-b-2 focus:border-[#8f9294] outline-none"></textarea>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" class="w-[18px] h-[18px] absolute right-2"
                                        viewBox="0 0 682.667 682.667">
                                        <defs>
                                            <clipPath id="a" clipPathUnits="userSpaceOnUse">
                            ...
                            <button type="button"
                                class="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded px-4 py-2.5 font-semibold bg-[#c0c4c7] text-gray-600 hover:bg-[#aeb2b4]">
